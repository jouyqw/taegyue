...
<meta name="author" content="김기태 변호사">
<link rel="canonical" href="${site}/blog/">
<link rel="alternate" hreflang="ko-KR" href="${site}/blog/">
<link rel="alternate" type="application/rss+xml" title="법무법인 태앤규 칼럼 RSS" href="${site}/rss.xml">
<meta property="og:type" content="website"><meta property="og:site_name" content="법무법인 태앤규"><meta property="og:locale" content="ko_KR">
<meta property="og:title" content="전주·익산·군산 개인회생 법률칼럼 | 법무법인 태앤규"><meta property="og:description" content="전주개인회생, 익산개인회생, 군산개인회생의 신청조건, 변제금, 최근 대출, 압류 대응과 준비서류를 설명하는 법률칼럼입니다."><meta property="og:url" content="${site}/blog/">
<meta property="og:image" content="${site}/og-cover.jpg"><meta property="og:image:width" content="1200"><meta property="og:image:height" content="630">
<meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="전주·익산·군산 개인회생 법률칼럼 | 법무법인 태앤규"><meta name="twitter:description" content="전주개인회생, 익산개인회생, 군산개인회생의 신청조건, 변제금, 최근 대출, 압류 대응과 준비서류를 설명하는 법률칼럼입니다."><meta name="twitter:image" content="${site}/og-cover.jpg">
...
{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"홈","item":"${site}/"},{"@type":"ListItem","position":2,"name":"개인회생 칼럼","item":"${site}/blog/"}]}
</script>
<style>
...
<main>
  <section class="hero"><div class="wrap"><span class="badge">LEGAL COLUMN</span><h1>전주·익산·군산 개인회생 법률칼럼</h1><p class="lead">개인회생 신청조건, 변제금, 소득자료, 최근 대출과 압류 대응 등 실제 상담에서 자주 묻는 질문을 지역별로 정리합니다.</p><nav class="region-nav" aria-label="지역·주제별 개인회생 안내"><a href="/jeonju-personal-rehabilitation/">전주개인회생 종합안내</a><a href="/jeonju-personal-rehabilitation-cost/">개인회생 비용</a><a href="/jeonju-personal-bankruptcy/">전주개인파산</a><a href="/blog/jeonju/">전주 칼럼</a><a href="/blog/iksan/">익산 칼럼</a><a href="/blog/gunsan/">군산 칼럼</a><a href="/blog/topic/repayment/">변제금</a><a href="/blog/topic/enforcement/">압류 대응</a><a href="/blog/topic/income/">소득 증빙</a><a href="/blog/topic/property/">재산·보증금</a><a href="/blog/topic/debt-type/">채무 유형별</a><a href="/blog/topic/procedure/">절차·서류</a></nav></div></section>
...
// 핵심 랜딩 페이지(scripts/build-pages.mjs)와 허브(scripts/build-hubs.mjs) 산출물
const TOPIC_KEYS = ['enforcement', 'income', 'property', 'repayment', 'debt-type', 'procedure'];
const staticUrls = [
  ...
  { loc: `${site}/location/`, changefreq: 'monthly', priority: '0.7' },
...
const sitemapUrls = [
  ...staticUrls,
  ...posts.map((post) => ({ loc: post.url, changefreq: 'monthly', priority: '0.6', lastmod: post.lastmod }))
];
