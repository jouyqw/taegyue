...
<p>익산 상담에서는 제조업·물류 종사자의 <strong>교대 근무 수당과 성과급 처리</strong>, 그리고 폐업 이후 남은 사업 채무를 어떻게 정리할지에 대한 문의가 많습니다. 관할·자격·변제금·서류를 한 번에 보시려면 <a href="/iksan-personal-rehabilitation/">익산개인회생 종합 안내</a>를 먼저 확인하시면 이해가 빠릅니다.</p>`,
  },
  gunsan: {
    h1: '군산개인회생 칼럼',
...
<p>고령이거나 소득이 생계비 수준에 못 미치는 경우에는 개인회생 대신 <a href="/jeonju-personal-bankruptcy/">개인파산</a>을 먼저 검토하기도 합니다. 소득 변동 소명 방법과 관할·변제금 기준은 <a href="/gunsan-personal-rehabilitation/">군산개인회생 종합 안내</a>에 정리해 두었습니다.</p>`,
  },
  common: null,
};
...
<div class="phero-cta"><a class="btn gold" href="tel:${PHONE}">${PHONE} 전화상담</a><a class="btn ghost" href="${KAKAO}" target="_blank" rel="noopener">카카오톡 상담</a><a class="btn ghost" href="/${region.key}-personal-rehabilitation/">${region.label}개인회생 종합 안내</a></div>
</div></section>
<div class="wrap">
${crumbHtml(trail)}
<div class="layout">
...
${sideCta([{ href: `/${region.key}-personal-rehabilitation/`, label: `${region.label}개인회생 종합 안내` }])}
</div></div>`;
